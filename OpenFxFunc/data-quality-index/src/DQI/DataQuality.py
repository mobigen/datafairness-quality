...
class DataQuality:
    def __init__(self, file_path=None, db_info=None, table_name=None):
        ...
        self.correction_stat = {"before": None, "after": None}
    ...
    def get_time_distribution(self, df, column_name, time_offset="Y"):
        ...
        try:
            ...
            time_index = df.set_index(column_name, drop=False, inplace=False)
            
            time_info = time_index.resample(time_offset)[column_name].count()
