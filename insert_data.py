...
company_fields = [
     "STATUS", "MESSAGE", "CORP_CODE", "CORP_NAME",
...
company_data = "/Users/cbc/DEV/Mobigen/datafairness-quality/sample_data/company_5000.csv"
...
biopics_fields = [
    ...
    "SUBJECT_RACE", "PERSON_OF_COLOR", "SUBJEC_SEX", "LEAD_ACTOR_ACTRESS"
]
...
def data_insert():
    ...
    iris.connect_db()
    iris.insert_query(data_list[data_name]["table_name"], data_list[data_name]["fields"], insert_data[1:])
    del iris
